...
# particle spacing gives good results [Neher2024](@cite).
...
# but their distribution near the surface can still be improved by adding boundary particles [Neher2024](@cite).
