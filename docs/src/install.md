...
julia --project=run -e 'using Pkg; Pkg.add("OrdinaryDiffEq")' # Install additional packages
```
...
- [PyPlot.jl](https://github.com/JuliaPy/PythonPlot.jl) -- Plotting library that can be used instead of Plots.jl
