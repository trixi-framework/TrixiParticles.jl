...
"""
struct FluidParticleContainer{NDIMS, ELTYPE <: Real, DC, SE, K, V, COR, C} <:
...
function update_density!(container::FluidParticleContainer, container_index, v, u, v_ode,
                         u_ode,
                         semi, t)
