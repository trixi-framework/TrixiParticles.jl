struct CubicSplitting{ELTYPE}
    ...
    relative_position :: Vector{SVectors{2, ELTYPE}}
    ...
    function CubicSplitting(; epsilon=0.5, alpha=0.5, center_particle=true)
        ...
        relative_position = [SVectors{2, ELTYPE}(epsilon * direction_1),
            SVectors{2, ELTYPE}(epsilon * direction_2),
            SVectors{2, ELTYPE}(epsilon * direction_3),
            SVectors{2, ELTYPE}(epsilon * direction_4)]
...
struct HexagonalSplitting{ELTYPE}
    ...
    function HexagonalSplitting(; epsilon=0.4, alpha=0.9, center_particle=true)
        ...
        relative_position = [SVectors{2, ELTYPE}(epsilon * direction_1),
            ...
            SVectors{2, ELTYPE}(epsilon * direction_3),
            SVectors{2, ELTYPE}(epsilon * direction_4),
            SVectors{2, ELTYPE}(epsilon * direction_5),
            SVectors{2, ELTYPE}(epsilon * direction_6)]
