...
export DEFAULT_GRAVITATIONAL_CONSTANT, NewtonianGravity, NoSoftening, PlummerSoftening,
       GravitatingParticleSystem, gravitational_mass, current_position, gravity_acceleration!
