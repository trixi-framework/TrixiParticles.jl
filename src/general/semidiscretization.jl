...
function calculate_dt(v_ode, u_ode, cfl_number, semi::Semidiscretization)
    ...
    foreach_system(semi) do system
        foreach_system(semi) do neighbor
            has_system_interaction(system, neighbor, semi) || return dt

            dt = min(dt, calculate_interface_dt(v_ode, u_ode, cfl_number,
...
@inline calculate_interface_dt(v_ode, u_ode, cfl_number, system, neighbor_system, semi) = Inf
