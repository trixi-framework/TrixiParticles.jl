...
coords = TrixiParticles.sample(triangle_mesh, 1.0, point_in_poly=TrixiParticles.WindingNumberJacobson())
#coords = sample(polygon, 0.1, point_in_poly=WindingNumberJacobson())
trixi2vtk(coords, filename="test_coords")
trixi2vtk(triangle_mesh.vertices, filename="mesh_coords")
