...
# Keywords
- `x_recess`: Vector for recess start and end coordinates in x direction
- `y_recess`: Vector for recess start and end coordinates in y direction
...
struct DrawCircle{}
    ...
    function DrawCircle(; n_layers=1)
        return new{}(n_layers)
    end
end
