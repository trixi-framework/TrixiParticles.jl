struct CircularShape{NDIMS, ELTYPE<:Real}
    ...
    function CircularShape(R, x_center, y_center, particle_spacing;
                           ...
                           n_layers=1, density=0.0)
        NDIMS = 2
        ELTYPE = eltype(particle_spacing)

        coordinates = generate_particles(shape_function, R, x_center, y_center, particle_spacing,
                                         x_recess, y_recess, n_layers)
...
```
"""
struct DrawCircle end


function generate_particles(::FillCircle, R, x_center, y_center, particle_spacing,
                            x_recess, y_recess, n_layers)
...
function generate_particles(::DrawCircle, R, x_center, y_center, particle_spacing,
                            x_recess, y_recess, n_layers)
