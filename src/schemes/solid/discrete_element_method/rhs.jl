function interact!(
        dv, v_particle_system, u_particle_system, v_neighbor_system,
    ...
    foreach_point_neighbor(
        ...
        if overlap > 0
            ...
            F_normal = collision_force_normal(
                particle_system.contact_model,
            ...
            F_tangent = collision_force_tangential(
                particle_system, neighbor_system,
            ...
            position_correction!(
                neighbor_system, u_particle_system, overlap, normal,
                particle
            )
        end
    end
...
@inline function collision_force_tangential(
        particle_system, neighbor_system,
        overlap, normal,
        v_particle_system, v_neighbor_system,
        particle, neighbor, F_normal
    ...
    tangential_stiffness = 1.0e3       # Tangential spring constant
...
@inline function position_correction!(
