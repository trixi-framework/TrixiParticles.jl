...
@inline particle_shifting(system) = nothing# ParticleShiftingSun2019(1.0)
...
# @propagate_inbounds function dv_particle_shifting(::ParticleShiftingSun2019,
#                                                   system, neighbor_system::BoundarySystem,
#                                                   v_system, v_neighbor_system, particle,
#                                                   neighbor,
#                                                   m_b, rho_b, grad_kernel)
#     delta_v_a = delta_v(system, particle)
#     delta_v_b = -delta_v(system, particle)
...
@inline function shifting_continuity_equation!(dv, ::ParticleShiftingSun2019, v_a, v_b,
                                               m_b, rho_a, rho_b, system, neighbor_system::BoundarySPHSystem,
                                               particle, neighbor, grad_kernel)
    delta_v_diff = rho_a * delta_v(system, particle)
    rho_v = rho_a * delta_v(system, particle)
    dv[end, particle] += m_b / rho_a * dot(delta_v_diff + 0rho_v, grad_kernel)

    return dv
end

# @inline function shifting_continuity_equation!(dv, ::ParticleShiftingSun2019, v_a, v_b,
#                                                m_b, rho_a, rho_b, system, neighbor_system::BoundarySystem,
#                                                particle, neighbor, grad_kernel)
#     delta_v_diff = 2 * rho_a * delta_v(system, particle)
#     rho_v = rho_a * delta_v(system, particle) - rho_b * delta_v(system, particle)
...
@inline function shifting_continuity_equation!(dv, ::ParticleShiftingSun2019, v_a, v_b,
                                               m_b, rho_a, rho_b, system, neighbor_system::FluidSystem,
                                               particle, neighbor, grad_kernel)
...
# function update_final2!(system::BoundarySPHSystem, v, u, v_ode, u_ode, semi, t)
#     update_shifting!(system, particle_shifting(system), v, u, v_ode, u_ode, semi, t)

#     return system
# end

# @propagate_inbounds function delta_v(system::BoundarySPHSystem, ::ParticleShiftingSun2019, particle)
#     return extract_svector(system.boundary_model.cache.delta_v, system, particle)
# end

# function update_shifting!(system::BoundarySPHSystem, particle_shifting::ParticleShiftingSun2019, v, u, v_ode,
#                           u_ode, semi, t)
#     (; delta_v) = system.boundary_model.cache
#     (; v_max) = particle_shifting
