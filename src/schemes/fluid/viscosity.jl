...
function dv_viscosity(particle_system, neighbor_system,
    ...
    viscosity = viscosity_model(neighbor_system, particle_system)
...
@inline function (viscosity::Union{ArtificialViscosityMonaghan,
    ...
    pi_ab = viscosity(sound_speed, v_diff, pos_diff, distance, rho_mean, rho_a, rho_b,
                      smoothing_length, grad_kernel, particle_system, neighbor_system)
...
@inline function (viscosity::ViscosityMorris)(c, v_diff, pos_diff, distance, rho_mean,
                                              rho_a, rho_b, h, grad_kernel, particle_system,
                                              neighbor_system)
    epsilon = viscosity.epsilon
    nu_a = viscosity_model(particle_system, neighbor_system).nu
    nu_b = viscosity.nu
