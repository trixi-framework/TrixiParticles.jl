...
function interact!(
    ...
    foreach_point_neighbor(
        ...
        @inbounds continuity_equation!(
            dv, density_calculator, v_particle_system,
...
@inline function continuity_equation!(
        dv, density_calculator::SummationDensity,
        v_particle_system, v_neighbor_system,
        particle, neighbor, pos_diff, distance,
        m_b, rho_a, rho_b,
        particle_system, neighbor_system, grad_kernel
...
@propagate_inbounds function continuity_equation!(
    ...
    return if particle_system === neighbor_system
        density_diffusion!(
            dv, density_diffusion, v_particle_system, particle, neighbor,
...
@propagate_inbounds function particle_neighbor_pressure(
        v_particle_system,
        v_neighbor_system,
        particle_system, neighbor_system,
        particle, neighbor
...
@inline function particle_neighbor_pressure(
        v_particle_system, v_neighbor_system,
        particle_system,
