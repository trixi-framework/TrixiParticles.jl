...
compact_support(::SchoenbergCubicSplineKernel, h) = 2 * h

normalization_factor(::SchoenbergCubicSplineKernel{2}, h) = 10 / (7 * pi * h^2)
normalization_factor(::SchoenbergCubicSplineKernel{3}, h) = 1 / (pi * h^3)
...
compact_support(::SchoenbergQuarticSplineKernel, h) = 2.5 * h

normalization_factor(::SchoenbergQuarticSplineKernel{2}, h) = 96 / (1199 * pi * h^2)
normalization_factor(::SchoenbergQuarticSplineKernel{3}, h) = 1 / (20 * pi * h^3)
