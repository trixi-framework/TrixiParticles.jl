...
function update2!(container::Union{FluidParticleContainer, BoundaryParticleContainer},
                  container_index, v, u,
                  v_ode, u_ode, semi, t)
...
function update4!(container, container_index, v, u, v_ode, u_ode, semi, t)
    # Update of all other containers (except SolidParticleContainer and FluidParticleContainer)
    update!(container, container_index, v, u, v_ode, u_ode, semi, t)
end
