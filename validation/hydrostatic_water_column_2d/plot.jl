...
# Alternative input files from out.
...
# ==========================================================================================
# ==== Create figure and layout (4 rows x 2 columns)
# Row 1: Simulation plots (data for t in [0, 0.5]); height = 300.
