    ...
    @testset verbose = true "Preprocessing" begin
        ...
        @trixi_testset "preprocessing/packing_2d.jl validation" begin
            ...
            expected_coordinates = [
                -0.540548 -0.189943 0.191664 0.542741 -0.629391 -0.196159 0.197725 0.63081 -0.629447 -0.196158 0.19779 0.631121 -0.540483 -0.190015 0.191345 0.540433;
            ...
            @test isapprox(packed_ic.coordinates, expected_coordinates, atol = 1.0e-5)
        end
