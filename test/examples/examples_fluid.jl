@testset verbose = true "Fluid" begin
    @trixi_testset "fluid/hydrostatic_water_column_2d.jl" begin
        ...
        hydrostatic_water_column_tests = Dict(
            ...
            "WCSPH with source term damping" => (source_terms = SourceTermDamping(damping_coefficient = 1.0e-4),),
            ...
            "WCSPH with SchoenbergQuarticSplineKernel" => (
            ...
            "EDAC with source term damping" => (
                source_terms = SourceTermDamping(damping_coefficient = 1.0e-4),
    ...
    @trixi_testset "fluid/oscillating_drop_2d.jl" begin
        ...
        @test isapprox(error_A, 0, atol = 2.0e-4)
        @test count_rhs_allocations(sol, semi) == 0
    end
    ...
    @trixi_testset "fluid/dam_break_2d.jl" begin
        ...
        dam_break_tests = Dict(
            ...
            "with BoundaryModelMonaghanKajtar" => (
    ...
    @trixi_testset "fluid/pipe_flow_2d.jl - steady state reached (`interval`)" begin
        ...
        @trixi_test_nowarn trixi_include(
            ...
            extra_callback = steady_state_reached, dtmax = 2.0e-3,
            tspan = (0.0, 1.5), viscosity_boundary = nothing
        )
