@testset verbose = true "`OpenBoundarySPHSystem`" begin
    @testset verbose = true "Illegal Inputs" begin
        ...
        @test_throws ArgumentError(error_str) OpenBoundarySPHSystem(
            inflow;
