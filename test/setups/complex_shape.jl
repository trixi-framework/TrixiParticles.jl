@testset verbose = true "ComplexShape" begin
    ...
    @testset verbose = true "2D" begin
        @testset verbose = true "Shifted Rectangle" begin
            ...
            test_name(
                algorithm, shift,
                particle_spacing
            ) = "Algorithm: $(TrixiParticles.type2string(algorithm))" *
                ", Shift: $shift" *
                ", Particle Spacing: $particle_spacing"
            @testset verbose = true "$(
                test_name(
                    point_in_geometry_algorithm, shift,
                    particle_spacing
                )
            )" for point_in_geometry_algorithm in algorithms,
                    shift in shifts,
                    particle_spacing in particle_spacings
                points_rectangle = stack(
                    [
                        [0.0, 0.0], [1.0, 0.0],
                ...
                shape_sampled = ComplexShape(
                    geometry; particle_spacing, density = 1.0,
        ...
        @testset verbose = true "Real World Data" begin
            ...
            @testset verbose = true "Algorithm: $(TrixiParticles.type2string(algorithms[i]))" for i in
                ...
                @testset verbose = true "Test File `$(files[j])`" for j in eachindex(files)
                    ...
                    shape_sampled = ComplexShape(
                        geometry; particle_spacing = 0.05,
                        density = 1.0, point_in_geometry_algorithm
                    )

                    @test isapprox(shape_sampled.coordinates, coords, atol = 1.0e-2)
                end
            end
        end
        ...
        @testset verbose = true "Setdiff of Overlapping Shapes and Geometries" begin
            ...
            expected_coords = [
                0.95 0.95 0.85 0.95 0.85 0.95 0.75 0.85 0.95 0.55 0.65 0.75 0.85 0.95 0.35 0.45 0.55 0.65 0.75 0.85 0.95;
    ...
    @testset verbose = true "3D" begin
        @testset verbose = true "Real World Data" begin
            ...
            @testset verbose = true "Naive Winding" begin
                @testset verbose = true "Test File `$(files[i])`" for i in eachindex(files)
                    ...
                    shape_sampled = ComplexShape(
                        geometry; grid_offset = 0.1,
                        particle_spacing = particle_spacings[i],
                        density = 1.0
                    )
                    @test isapprox(shape_sampled.coordinates, coords, atol = 1.0e-3)
                end
            end
        ...
        @testset verbose = true "Intersect of Overlapping Shapes and Geometries" begin
            ...
            expected_coords = [
                0.05 0.15 0.25 0.35 0.45 0.55 0.65 0.05 0.15 0.25 0.35 0.45 0.55 0.65 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.35 0.05 0.15 0.05 0.15 0.25 0.35 0.45 0.55 0.65 0.05 0.15 0.25 0.35 0.45 0.55 0.65 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.35 0.05 0.15 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.55 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.35 0.05 0.15 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.35 0.45 0.05 0.15 0.25 0.35 0.05 0.15 0.25 0.05 0.15 0.25 0.35 0.05 0.15 0.25 0.35 0.05 0.15 0.25 0.05 0.15 0.05 0.15 0.05 0.15;
