...
min_coords_pile = (
    pile_center[1] - pile_size[1] / 2,
    pile_center[2] - pile_size[2] / 2,
    pile_min_z,
)
sand_particles = RectangularShape(
    particle_spacing, n_particles_pile, min_coords_pile;
...
# ==========================================================================================
# ==== Systems
contact_model = LinearContactModel(1.0e6)
damping_coefficient = 0.00001

sand_system = DEMSystem(
    sand_particles, contact_model;
