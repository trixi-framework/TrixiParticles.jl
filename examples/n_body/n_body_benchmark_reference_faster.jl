...
const PAIRS = Tuple((i, j) for i in 1:4 for j in (i + 1):5)
...
function init_sun(bodies)
    ...
    return Body((0.0, 0.0, 0.0), p ./ SOLAR_MASS, SOLAR_MASS)
end
...
const bodies = [
    ...
    Body(
        ...
        (
            ...
            -9.5159225451971587e-5DAYS_PER_YEAR,
        ),
