...
pp = PostprocessCallback(;
    dt = 0.005, filename = "example_pressure_ekin", avg_pressure,
...
p1 = Plots.plot(
    data.time, data.kinetic_energy_fluid_1, color = :blue,
    title = "Kinetic Energy", xlabel = "Time", ylabel = "Kinetic Energy"
)
p2 = Plots.plot(
    data.time, data.avg_pressure_fluid_1, color = :red,
