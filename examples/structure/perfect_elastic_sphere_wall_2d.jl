...
contact_model_spec = PerfectElasticBoundaryContactModel(; normal_stiffness=2.0e5,
...
# `RigidContactModel` coefficients internally.
...
contact_clearance_threshold = 1.2 * contact_model_spec.contact_distance
