...
trixi_include(@__MODULE__,
              ...
              surface_tension_coefficient=0.5, dt=0.25, tspan=(0.0, 100.0), nu,
              smoothing_length=1.5 * particle_spacing,
              fluid_smoothing_kernel=WendlandC2Kernel{3}(), particle_spacing, sound_speed,
              fluid_density, fluid_size)
