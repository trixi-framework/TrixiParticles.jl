...
# Carreau–Yasuda parameters for the *liquid* 
# ν∞ << ν0 and n << 1 ->  shear-thinning 
ν0     = 0.05                 # Zero-shear viscosity 
ν∞     = 0.001*ν0             # Infinite-shear viscosity ( 1000:1 ratio)
λ      = 0.05                 # Time constant 
a_cy   = 2.0
...
function build_simulation(; viscosity_liquid, viscosity_gas, output_prefix::String)
    ...
    # Pressure smoothing correction for stability 
