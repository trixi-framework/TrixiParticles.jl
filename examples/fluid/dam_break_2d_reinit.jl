...
saving_callback = SolutionSavingCallback(interval=1, append_timestamp=true)
#correction_cb = DensityReinitializationCallback(particle_container, dt=0.1)
info_callback = InfoCallback(interval=100)

callbacks = CallbackSet(info_callback, saving_callback)
#callbacks = CallbackSet(info_callback, correction_cb, saving_callback)
...
#correction_cb = DensityReinitializationCallback(particle_container, dt=0.1)
saving_callback = SolutionSavingCallback(dt=0.02, append_timestamp=true)
callbacks = CallbackSet(info_callback, saving_callback)
#callbacks = CallbackSet(info_callback, correction_cb, saving_callback)
