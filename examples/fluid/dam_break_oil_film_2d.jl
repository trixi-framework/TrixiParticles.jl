...
oil_size = (W, 0.1 * H)
oil_density = 700.0
oil_eos = StateEquationCole(;
    sound_speed, reference_density = oil_density, exponent = 1,
    clip_negative_pressure = false
)

oil = RectangularShape(
...
oil_state_equation = StateEquationCole(;
    sound_speed, reference_density = oil_density,
    exponent = 1, clip_negative_pressure = false
)
oil_system = WeaklyCompressibleSPHSystem(
    oil, fluid_density_calculator,
...
semi = Semidiscretization(
    fluid_system, oil_system, boundary_system,
