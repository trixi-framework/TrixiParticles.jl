...
tank = RectangularTank(particle_spacing, (0.0, 0.0), (1.5, 1.0), fluid_density,
                       pressure=pressure, n_layers=boundary_layers,
                       faces=(false, true, true, true),
                       min_coordinates=(1.0 + particle_spacing * open_boundary_layers,
                                        -0.6))

tank_wall_left = RectangularShape(particle_spacing,
                                  (boundary_layers,
                                   round(Int, (1.0 - domain_size[2]) / particle_spacing)),
                                  (1.0 + particle_spacing * open_boundary_layers, -0.6),
...
# ==========================================================================================
# ==== Simulation
semi = Semidiscretization(fluid_system, open_boundary_in, boundary_system,
