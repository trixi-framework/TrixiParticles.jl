...
n_buffer_particles = 4 * pipe.n_particles_per_dimension[2]^2
...
inflow = InFlow(;
                plane=([0.0, 0.0, 0.0], [0.0, domain_size[2], 0.0],
...
outflow = OutFlow(;
                  plane=([domain_size[1], 0.0, 0.0], [domain_size[1], domain_size[2], 0.0],
