...
sphere2 = SphereShape(
    fluid_particle_spacing, sphere_radius, sphere2_center,
    fluid_density, sphere_type = VoxelSphere(), velocity = (0.0, -3.0)
)
...
sphere_surface_tension = EntropicallyDampedSPHSystem(
    sphere1, fluid_smoothing_kernel,
...
sphere = WeaklyCompressibleSPHSystem(
    sphere2, fluid_density_calculator,
...
boundary_system = BoundarySPHSystem(
    tank.boundary, boundary_model,
...
sol = solve(
    ode, RDPK3SpFSAL35(),
    abstol = 1.0e-7, # Default abstol is 1e-6
