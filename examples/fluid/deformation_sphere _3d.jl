...
setup = RectangularShape(particle_spacing, (5,5,5), (0.0, 0.0, 0.0), density = water_density)
...
particle_container = FluidParticleContainer(setup.coordinates,
	...
	surface_tension = SurfaceTensionAkinci(surface_tension_coefficient=0.1, support_length=1.0*particle_spacing))
