...
#                smoothing_length, density_calculator=SummationDensity(), state_equation,
#                reference_particle_spacing=particle_spacing, viscosity=ArtificialViscosityMonaghan(; alpha, beta=0.0),
