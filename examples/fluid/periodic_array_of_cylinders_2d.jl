...
box = RectangularTank(
    particle_spacing, fluid_size, tank_size,
    fluid_density, n_layers = boundary_layers,
    pressure = pressure, faces = (false, false, true, true)
)

cylinder = SphereShape(
    particle_spacing, cylinder_radius, tank_size ./ 2,
...
fluid_system = EntropicallyDampedSPHSystem(
    fluid, smoothing_kernel, smoothing_length,
...
boundary_model = BoundaryModelDummyParticles(
    boundary.density, boundary.mass,
