...
box = RectangularShape(fluid_particle_spacing, (200, 50), (0.49, 0.0), density=fluid_density)

sphere_radius = 0.0025

sphere1_center = (0.5, 0.1)
sphere2_center = (0.5, 0.15)
sphere3_center = (0.5, 0.2)
sphere4_center = (0.5, 0.25)
sphere1 = SphereShape(fluid_particle_spacing, sphere_radius, sphere1_center,
                      fluid_density, sphere_type=VoxelSphere(), velocity=(0.0, -5.0))
...
sphere_surface_tension = WeaklyCompressibleSPHSystem(water, fluid_density_calculator,
                                                     ...
                                                     surface_tension=SurfaceTensionAkinci(surface_tension_coefficient=0.5*0.011),
...
saving_callback = SolutionSavingCallback(dt=0.0025, output_directory="out", prefix="four_drop_terminal_90d_box",
