...
# However, BoundaryModelDummyParticles can only be used when the plate thickness is at least
# two fluid particle spacings, so that the compact support is fully sampled, or fluid
