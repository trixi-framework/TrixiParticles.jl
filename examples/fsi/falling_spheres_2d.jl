...
sphere1 = SphereShape(
    solid_particle_spacing, sphere1_radius, sphere1_center,
    sphere1_density, sphere_type = VoxelSphere()
)
sphere2 = SphereShape(
    solid_particle_spacing, sphere2_radius, sphere2_center,
...
solid_boundary_model_2 = BoundaryModelDummyParticles(
    hydrodynamic_densites_2,
...
solid_system_1 = TotalLagrangianSPHSystem(
    sphere1,
...
solid_system_2 = TotalLagrangianSPHSystem(
    sphere2,
    solid_smoothing_kernel, solid_smoothing_length,
    sphere2_E, nu,
    acceleration = (0.0, -gravity),
...
saving_callback = SolutionSavingCallback(
    dt = 0.02, output_directory = "out", prefix = "",
...
sol = solve(
    ...
    reltol = 1.0e-3, # Default reltol is 1e-3
