# ==========================================================================================
# 3D Falling Spheres in Fluid (FSI) - Base Setup
#
...
initial_fluid_size = (1.0, 0.9, 1.0)
...
sphere1_center = (0.5, 1.6, 0.5)
sphere2_center = (0.7, 1.6, 0.5)
...
structure_smoothing_kernel = WendlandC2Kernel{3}()
...
saving_callback = SolutionSavingCallback(dt=0.02, output_directory="out_3d", prefix="")
