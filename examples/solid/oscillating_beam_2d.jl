...
fixed_particles = SphereShape(
    particle_spacing, clamp_radius + particle_spacing / 2,
...
n_particles_per_dimension = (
    round(Int, elastic_beam.length / particle_spacing) +
...
solid_system = TotalLagrangianSPHSystem(
    solid, smoothing_kernel, smoothing_length,
